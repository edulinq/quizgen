...
# Output formats.
DOC_FORMATS = [FORMAT_GIFT, FORMAT_HTML, FORMAT_JSON, FORMAT_MD, FORMAT_TEX, FORMAT_TEXT]

# Formats that the parser understands basic conversions to.
PARSER_FORMATS = [FORMAT_HTML, FORMAT_JSON, FORMAT_MD, FORMAT_TEX, FORMAT_TEXT]
