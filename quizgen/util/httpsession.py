...
class SessionRecorder(object):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self._out_dir = quizgen.util.dirent.get_temp_path('quizgen-http-recorded-session-', rm = False)
    ...
    def _wrap_request(self,
        ...
        quizgen.util.json.dump_path(result, out_path, indent = 4)
...
def _hash_dict(data):
    json = quizgen.util.json.dumps(data)
    return quizgen.util.hash.sha256(json)
