"""
Upload a gradescope quiz that has already been created via quizgen.cli.gradescope.create.
"""
...
def _get_parser():
    parser = argparse.ArgumentParser(description =
        "Parse a single variant output generated by quizgen.cli.gradescope.create and upload the quiz to GradeScope."
        + " Most users should be using quizgen.cli.gradescope.create instead.")
