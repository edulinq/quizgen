...
\usepackage[
    pdftex,
    hidelinks,
    pdftitle={  - Docker Test Quiz},
    pdfcreator={Quiz Generator},
    pdfkeywords={Version: f381d504-d}
]{hyperref}
...
\centerline{\Large  \hfill Docker Test Quiz \hfill }
\vspace{0.2cm}
...
\fancyhead{}
\fancyhead[L]{}
\fancyhead[C]{Docker Test Quiz}
\fancyhead[R]{}
\renewcommand{\headrulewidth}{0.1mm}
\fancyfoot{}
\fancyfoot[R]{\thepage}
\fancyfoot[L]{Version: f381d504-d}
