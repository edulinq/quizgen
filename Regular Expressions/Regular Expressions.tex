...
\end{center}
    ...
    \bigAnswerBox[]{4em}{1.0}{short_answer}{0.0}{0}{0}
...
\end{lstlisting}
    ...
    \bigAnswerBox[]{4em}{0.25}{numerical}{5.0}{0}{0}
    ...
    For each part (denoted by angle brackets), fill in the circle that corresponds to your answer.
        ...
        PART1:
            ...
            \begin{center}
                ...
                \begin{tabular}{ >{\centering\arraybackslash}m{0.06\textwidth} m{0.15\textwidth} }
                    \radio{multiple_dropdowns}{6.0}{6.0.0}{0}
                        & \verb|?| \\
                \end{tabular}
                \begin{tabular}{ >{\centering\arraybackslash}m{0.06\textwidth} m{0.15\textwidth} }
        ...
        PART2:
            ...
            \begin{center}
                ...
                \end{tabular}
                \begin{tabular}{ >{\centering\arraybackslash}m{0.06\textwidth} m{0.15\textwidth} }
                    \radio{multiple_dropdowns}{6.0}{6.0.1}{2}
                        & \verb|+| \\
                \end{tabular}
        ...
        PART3:
            ...
            \begin{center}
                ...
                \begin{tabular}{ >{\centering\arraybackslash}m{0.06\textwidth} m{0.15\textwidth} }
                    \radio{multiple_dropdowns}{6.0}{6.0.2}{0}
                        & \verb|*| \\
                \end{tabular}
                \begin{tabular}{ >{\centering\arraybackslash}m{0.06\textwidth} m{0.15\textwidth} }
...
\end{itemize}
    ...
    \calcremainingheight
    \bigAnswerBox[]{\remainingheight}{1.0}{essay}{10.0}{0}{0}
